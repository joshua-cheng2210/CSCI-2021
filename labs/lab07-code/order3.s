...
#       leaq    0(%rsp), %rdi          # arg1 &r - same effect, different instruction
        ...
        movl    $9, 16(%rsp)           # e=9
        movl    $2, 20(%rsp)           # d=2
        leaq    12(%rsp), %rdi          # arg1 &q - same effect, different instruction
        leaq    16(%rsp), %rsi          # arg2 &e
        leaq    20(%rsp), %rdx          # arg3 &d
        call    order3                 # function call
        ...
        movl    $27, 28(%rsp)           # j=27
        movl    $29, 32(%rsp)           # k=29
        leaq    24(%rsp), %rdi          # arg1 &i - same effect, different instruction
        leaq    28(%rsp), %rsi          # arg2 &j
        leaq    32(%rsp), %rdx          # arg3 &k
        call    order3                 # function call
