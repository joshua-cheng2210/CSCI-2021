...
// Calculate number of quarters, dimes, nickels, pennies of change.
// Param cents is the number of cents, 0-99.
// Param coins is a pointer to a structure which will have its fields set to
// the number of coins of each type.
// Returns 0 on success.
// If cents is out of range, no values are changed and 1 is returned.
